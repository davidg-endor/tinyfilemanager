...
//Application Title
define('APP_TITLE', 'Endor File Manager');
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <link href="assets/css/ajax/libs/dropzone/5.5.1/min/dropzone.min.css" rel="stylesheet">
    <div class="path">
    ...
    <script src="assets/js/ajax/libs/dropzone/5.5.1/min/dropzone.min.js"></script>
    <script>
...
function fm_get_translations($tr) {
    try {
        $content = @file_get_contents('assets/translation.json');
        if($content !== FALSE) {
...
<script src="assets/js/ajax/libs/jquery/3.4.1/jquery.slim.min.js"></script>
<script src="assets/js/bootstrap/4.4.1/js/bootstrap.min.js"></script>
</body>
</html>
<?php
}
...
<head>
    ...
    <title><?php echo fm_enc(APP_TITLE) ?></title>
    <link rel="stylesheet" href="assets/css/bootstrap/4.4.1/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/css/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="assets/css/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.css" />
    <?php if (FM_USE_HIGHLIGHTJS): ?>
    <link rel="stylesheet" href="assets/css/ajax/libs/highlight.js/9.15.10/styles/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
    <?php endif; ?>
    <style>
...
<script src="assets/js/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
<script src="assets/js/bootstrap/4.4.1/js/bootstrap.min.js"></script>
<script src="assets/js/1.10.20/js/jquery.dataTables.min.js"></script>
<script src="assets/js/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.min.js"></script>
<?php if (FM_USE_HIGHLIGHTJS): ?>
    <script src="assets/js/ajax/libs/highlight.js/9.15.10/highlight.min.js"></script>
...
<script>
    ...
    //TFM Config
    window.curi = "assets/config.json", window.config = null;
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE): 
        ...
        ?>
    <script src="assets/js/ajax/libs/ace/1.4.1/ace.js"></script>
    <script>
